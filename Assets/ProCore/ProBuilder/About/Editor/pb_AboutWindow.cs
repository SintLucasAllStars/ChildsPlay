...
namespace ProBuilder2.EditorCommon
{
    ...
    public class pb_AboutWindow : EditorWindow
    {
        ...
        private readonly GUIContent gc_Banner = new GUIContent("", "ProBuilder Quick-Start Video Tutorials");
        private readonly GUIContent gc_Contact = new GUIContent("Contact Us", "Send us an email!");
        private readonly GUIContent gc_Forum = new GUIContent("Support Forum", "ProCore Support Forum");

        private readonly GUIContent gc_Learn = new GUIContent("Learn ProBuilder", "Documentation");
        ...
        internal static string AboutRoot
        {
            get
            {
                if (Directory.Exists(aboutRoot)) return aboutRoot;
        ...
        public static bool Init(bool fromMenu)
        {
            ...
            {
                pb_AboutWindow win;
                win = (pb_AboutWindow) GetWindow(typeof(pb_AboutWindow), true, about.name, true);
                win.ShowUtility();
                win.SetAbout(about);
        ...
        public void OnEnable()
        {
            ...
            else
            {
                ...
                minSize = new Vector2(BANNER_WIDTH + 24, BANNER_HEIGHT * 2.5f);
                maxSize = new Vector2(BANNER_WIDTH + 24, BANNER_HEIGHT * 2.5f);
