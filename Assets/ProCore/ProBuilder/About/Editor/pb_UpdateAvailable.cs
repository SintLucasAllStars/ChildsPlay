...
namespace ProBuilder2.EditorCommon
{
    internal class pb_UpdateAvailable : EditorWindow
    {
        ...
        private readonly GUIContent gc_DownloadUpdate = new GUIContent("", "Open Asset Store Download Page");
        [SerializeField] private string m_NewChangelog;

        [SerializeField] private pb_VersionInfo m_NewVersion;
        ...
        {
            var win = GetWindow<pb_UpdateAvailable>(true, "ProBuilder Update Available", true);
        ...
        private void OnEnable()
        {
            ...
            downloadImageStyle = new GUIStyle
            {
                ...
                {
                    background =
                        pb_AboutWindow.LoadAssetAtPath<Texture2D>(string.Format("{0}/Images/DownloadPB_Normal.png",
                            pb_AboutWindow.AboutRoot))
                },
                hover = new GUIStyleState
                {
                    background =
                        pb_AboutWindow.LoadAssetAtPath<Texture2D>(string.Format("{0}/Images/DownloadPB_Hover.png",
                            pb_AboutWindow.AboutRoot))
                }
            };
            ...
            updateHeader = new GUIStyle
            {
                ...
                fontSize = 24,
                wordWrap = true,
                font = pb_AboutWindow.LoadAssetAtPath<Font>(string.Format("{0}/Font/{1}", pb_AboutWindow.AboutRoot,
                    pb_AboutWindow.FONT_MEDIUM)),
                normal = new GUIStyleState
                {
                    textColor = EditorGUIUtility.isProSkin ? pb_AboutWindow.font_white : pb_AboutWindow.font_black
                }
            };
        }
