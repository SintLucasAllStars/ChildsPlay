...
namespace ProBuilder2.Actions
{
    ...
    {
        [MenuItem("Tools/" + pb_Constant.PRODUCT_NAME + "/Repair/Rebuild ProBuilder Objects", true,
        ...
        [MenuItem("Tools/" + pb_Constant.PRODUCT_NAME + "/Repair/Rebuild ProBuilder Objects", false,
            pb_Constant.MENU_REPAIR)]
        public static void DoRebuildMeshes()
        {
            StripAndProBuilderize(Selection.transforms.GetComponents<pb_Object>());
        }
        ...
        private static void StripAndProBuilderize(pb_Object[] targets, bool interactive = true)
        {
            ...
            if (interactive)
            {
                ...
                EditorUtility.DisplayDialog("Rebuild ProBuilder Objects",
                    "Successfully rebuilt " + targets.Length + " ProBuilder Objects", "Okay");
            }
        }
        ...
        private static void RebuildProBuilderMesh(pb_Object pb)
        {
            ...
            {
                Debug.LogError("Failed rebuilding ProBuilder mesh: " + e);
            }
        }
    }
}